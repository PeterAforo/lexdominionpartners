...
const posts = [
  { title: 'Understanding Corporate Mergers: A Legal Perspective', excerpt: 'Navigate the complex landscape of corporate mergers with insights from our experienced team.', date: '2026-03-20', category: 'Corporate Law', slug: 'understanding-corporate-mergers' },
  { title: 'Protecting Your Intellectual Property in the Digital Age', excerpt: 'Learn how to safeguard your innovations and creative works in an increasingly digital world.', date: '2026-03-15', category: 'Intellectual Property', slug: 'protecting-ip-digital-age' },
  { title: 'Family Law Updates: What You Need to Know in 2026', excerpt: 'Stay informed about the latest changes in family law and how they might affect your rights.', date: '2026-03-10', category: 'Family Law', slug: 'family-law-updates-2026' },
  { title: 'Navigating Immigration Law Changes', excerpt: 'Recent policy shifts have significant implications for businesses and individuals seeking immigration services.', date: '2026-03-05', category: 'Immigration', slug: 'navigating-immigration-changes' },
  { title: 'Tax Planning Strategies for 2026', excerpt: 'Expert tax attorneys share strategies to minimize liability and maximize your financial position.', date: '2026-02-28', category: 'Tax Law', slug: 'tax-planning-2026' },
  { title: 'The Rise of Alternative Dispute Resolution', excerpt: 'Why more businesses are turning to mediation and arbitration over traditional litigation.', date: '2026-02-20', category: 'Litigation', slug: 'alternative-dispute-resolution' },
]
