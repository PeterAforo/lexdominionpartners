...
const fallbackTeam = [
  { name: 'Alexander Mensah', slug: 'alexander-mensah', title: 'Managing Partner', specialty: 'Corporate Law', image: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=600&q=80' },
  { name: 'Victoria Adeyemi', slug: 'victoria-adeyemi', title: 'Senior Partner', specialty: 'Litigation', image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=600&q=80' },
  { name: 'Marcus Okafor', slug: 'marcus-okafor', title: 'Partner', specialty: 'Real Estate', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&q=80' },
  { name: 'Catherine Nkosi', slug: 'catherine-nkosi', title: 'Partner', specialty: 'Family Law', image: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=600&q=80' },
  { name: 'Jonathan Afolabi', slug: 'jonathan-afolabi', title: 'Partner', specialty: 'Criminal Defense', image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=600&q=80' },
  { name: 'Sophia Dlamini', slug: 'sophia-dlamini', title: 'Partner', specialty: 'Intellectual Property', image: 'https://images.unsplash.com/photo-1589156229687-496a31ad1d1f?w=600&q=80' },
  { name: 'Daniel Asante', slug: 'daniel-asante', title: 'Senior Associate', specialty: 'Immigration', image: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=600&q=80' },
  { name: 'Amara Osei', slug: 'amara-osei', title: 'Senior Associate', specialty: 'Tax Law', image: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=600&q=80' },
]
    ...
    fetch('/api/team')
      ...
      .then((data) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          setTeam(fallbackTeam as unknown as TeamMemberData[])
        }
      })
      .catch(() => setTeam(fallbackTeam as unknown as TeamMemberData[]))
                  ...
                  <HoverScale>
                    <Link href={`/team/${member.slug}`} className="group block bg-white rounded-sm overflow-hidden card-hover border border-gray-100">
                      <div className="aspect-[3/4] bg-navy-800 relative overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-4 max-sm:translate-y-0 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                          <div className="flex gap-3 justify-center">
                            {member.email && <span className="w-9 h-9 bg-gold-400 rounded-full flex items-center justify-center"><Mail size={16} className="text-navy-800" /></span>}
                            {member.phone && <span className="w-9 h-9 bg-gold-400 rounded-full flex items-center justify-center"><Phone size={16} className="text-navy-800" /></span>}
                      ...
                      <div className="p-5">
                        ...
                        {member.specialty && <p className="text-gray-500 text-xs mt-1">{member.specialty}</p>}
                      </div>
                    </Link>
                  </HoverScale>
                </StaggerItem>
