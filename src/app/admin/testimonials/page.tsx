...
const emptyForm = { name: '', title: '', company: '', content: '', rating: 5, order: 0 }
...
export default function AdminTestimonialsPage() {
  ...
  const startEdit = (t: any) => {
    setEditingId(t.id)
    setForm({ name: t.name, title: t.title || '', company: t.company || '', content: t.content, rating: t.rating, order: t.order })
    setShowForm(true)
  }
